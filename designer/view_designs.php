		...
		<div class="page-content">
			...
			<div class="row">
				<div class="col-sm-12">
					<div class="card-box">
						<div class="card-head">
							<header>Design Information</header>
						</div>
						<div class="card-body ">
								...
								<table class="table table-hover table-checkable order-column full-width " id="example4">
									<thead>
										<tr>
											...
											<th class="center">Design Category</th>
											<th class="center">Added On</th>
											<th class="center">Design Picture</th>
									...
									<tbody>
										...
										if (isset($_GET['search']) && $_GET['search'] == 'buyer') {
											...
											// GET User Details --------------------------------------------------------
											$query_user = "SELECT * FROM `designs` WHERE user_id=" . $user_id;
										}
										$u_name = "";
										$u_email = "";
										$u_status = "";
										...
										if ((mysqli_num_rows($query_result_user) > 0)) {
											...
											while ($result_user = mysqli_fetch_assoc($query_result_user)) {
												...
												$u_name = $result_user['dName'];
												$dCatagory = $result_user['dCatagory'];
												$dPrice = $result_user['dPrice'];
												$description = $result_user['description'];
												$dPic = $result_user['dPic'];
												$u_id = $result_user['id'];
												...
												<tr>
													...
													<td class="center">
														<div class="sidebar-userpic ">
															<img class="shadow-lg" style="height:70px" src="../General_Assets/assets/img/Designs/<?php echo $dPic; ?>" class="img-responsive img fluid" alt="">
														</div>
														<?php
													...
													<td class="center">
													<a href="edit_design.php?id=<?php echo $u_id;?>" class="btn btn-tbl-edit btn-xs">
														Edit
													</a>
													<a href="delete_design.php?id=<?php echo $u_id;?>" class="btn btn-tbl-delete btn-xs">
														Delete
													</a>
