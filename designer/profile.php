...
$u_name = $_SESSION['designer_user_name'];
$u_password = $_SESSION['designer_user_pass'];
$u_profile_img = "";
...
if ((mysqli_num_rows($query_result_user) > 0)) {
	...
	$_SESSION['designer_user_name'] = $u_name;
	$_SESSION['designer_profile_img'] = $result_user['profile_img'];;
}
								...
								<div class="col">
									<div class="row">
										<div class="sidebar-userpic">
											<img src="../General_Assets/assets/img/<?php echo $_SESSION['designer_profile_img']; ?>" class="img-responsive" alt="" style="width:66px; margin:auto;" id="d_p_img">
										</div>
									</div>
								</div>
							</div>
						...
						<?php } else { ?>
							...
							<div class="crediet_card bg-light medium_b_raius p-3 pt-1 text-dark mx-md-5">
								...
								<div class="row px-4 py-4">
									...
									<div class="col-md-9 col-12  px-3">
										<input id="my-input" class="form-control input_b_raius" type="text" name="add_card_title" id="card_title" placeholder="Admin">
									</div>
								</div>
								<div class="row px-4 py-4">
									<div class="col-md-2 ml-md-5 ">
