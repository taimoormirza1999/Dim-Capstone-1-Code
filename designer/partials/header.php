...
if(isset($_SESSION['designer_login']) && $_SESSION['designer_login'] =='loged_in'){
	
	$username=$_SESSION['designer_user_name'];
...
.dark-sidebar-color .sidemenu-container,.logo-dark .page-header.navbar .page-logo,.dark-sidebar-color .page-container,.deep_dark,.designer_primary{
				...
				<div class="top-menu">
					...
					<ul class="nav navbar-nav pull-right">
						...
						<li class="dropdown dropdown-user">
							...
							<img alt="" class="img-circle " src="../General_Assets/assets/img/<?php echo $_SESSION['designer_profile_img'];?>" />
