...
<html lang="en">
	...
	<style>
.dark-sidebar-color .sidemenu-container,.logo-dark .page-header.navbar .page-logo,.dark-sidebar-color .page-container,.admin_primary{
	background-color:#151728e6;
				...
				<div class="top-menu">
					...
					<ul class="nav navbar-nav pull-right">
						...
						<li class="dropdown dropdown-user">
							...
							<img alt="" class="img-circle " src="../General_Assets/assets/img/<?php echo $_SESSION['profile_img']; ?>" />
								<span class="username username-hide-on-mobile m_bolder">Balance $500 </span>
