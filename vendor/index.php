							...
							<div class="state-overview">
								<div class="row">
									<div class="col-6  shadow-lg">
										<a href="view_products.php" class="text-light">
											<div class="overview-panel vendor_primary">
												<div class="symbol">
												...
												<div class="value white">
													<p class="sbold addr-font-h1" data-counter="counterup" data-value="<?php echo get__total_products($con, $userid); ?>">0</p>
													<p>Listed Products</p>
												</div>
											</div>
										</a>
									...
									<div class="col-6  shadow-lg">
										<a href="javascript:;" class="text-light">
											<div class="overview-panel vendor_primary">
												...
												<div class="value white">
													<p class="sbold addr-font-h1" data-counter="counterup" data-value="<?php echo 3; ?>">0</p>
													<p>Monitor Orders</p>
												</div>
											</div>
										</a>
